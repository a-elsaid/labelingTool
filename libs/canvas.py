...
class Canvas(QWidget):
    ...
    def setLastLabel(self, text, line_color  = None, fill_color = None, group=None, sex=None, condition=None, source=None ):
        assert text
        self.shapes[-1].label = text
        self.shapes[-1].group = group
        self.shapes[-1].sex = sex
        self.shapes[-1].condition = condition
        self.shapes[-1].source = source
        if line_color:
